...
const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" className="py-20 px-4 bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
