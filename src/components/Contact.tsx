    ...
    >
      <div className="max-w-5xl mx-auto text-gray-900 dark:text-white">
        ...
        <div className="bg-gradient-to-br from-white via-slate-50 to-white dark:from-[#071f82] dark:via-[#081237] dark:to-[#0a1749] rounded-[20px] border border-white/10 shadow-[0_20px_60px_rgba(2,6,23,0.7)] px-6 py-10 md:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 mt-10">
            {contactChannels.map(({ label, value, href, icon: Icon }) => (
              <a
                ...
                rel="noreferrer"
                className="group flex items-center justify-between rounded-2xl border border-black/50 bg-white/70 dark:bg-white/5 px-5 py-5 hover:bg-white/90 dark:hover:bg-white/10 transition"
              >
          ...
          <div className="mt-10 rounded-2xl border border-white/10 bg-white/80 dark:bg-white/5 px-6 py-4 text-gray-700 dark:text-white/70 text-sm">
