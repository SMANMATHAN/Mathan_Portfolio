  ...
  const contactInfo = [
    {
      ...
      link: 'mailto:manmadhansiva2005@gmail.com'
    },
    {
      icon: <Phone className="w-6 h-6" />,
      title: 'Phone',
      value: '+91 9363212045',
      link: 'tel: +91 9363212045'
    },
    {
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                ...
                or just having a conversation about technology and innovation. Whether 
                you're looking for a developer, have a project idea, or want to collaborate, 
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className={`w-12 h-12 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center text-gray-600 dark:text-gray-400 transition-all duration-300 ${social.color} hover:text-white transform hover:scale-110`}
